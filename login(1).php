...
<head>
    ...
    <title>
        कोलाम सर्व्हेक्षण व नोंदणी पोर्टल
    </title>
...
<body class="" style="overflow-x: hidden;">     
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                        <div class="card z-index-0">
                            <div class="text-center pt-4">
                                <h5>आदि कोलाम सर्वेक्षण व नोंदणी पोर्टल</h5>
                            </div>
                            <div class="card-body">
    ...
    <script>
        // Swal.fire({
        //   title: "<span style='color:red'>Server Expiry Warning!</span>",
        // //   text: "Subscription end date 5th July 2024 contact SETTribe for renewal.",
        //   html: "Server will expire on <span style='color:red'>28th Feb 2025</span>. Please renew it immediately by contacting SETTribe to prevent downtime.",
        //   icon: "warning"
        // });
    </script>
    <?php 
