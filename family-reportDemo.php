                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table id="example" class="table" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $query = mysqli_query($con,"SELECT DISTINCT(familyId), name FROM familyDetails GROUP BY familyId;") or die("errror");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="family-detailsDemo?familyId=<?php echo $familyId ?>&member="><button type="submit" class="btn btn-primary m-3">photo
                                                            </button></a>
                                                             <!--<input type="file" id="myFile" accept="image/*" class="form-control">-->
