...
<span class="ms-1 font-weight-bold">Pardhi Survey Form</span>
</a>
</div>
...
</aside>     <main class="main-content position-relative max-height-vh-100
            h-100 border-radius-lg ">

            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4
                shadow-none border-radius-xl" id="navbarBlur"
                navbar-scroll="true">
                        ...
                        <div class="card z-index-2">
                            ...
                            <div class="card-body p-3">
                                <form action="education-details_db" method="post">
                                    <input type="hidden" value="63ce4ee37efff"
                                        name="familyId">
                                    <div class="row">
                                        <div class="col-md-6">
                                        <div class="form-group">
                                        <label class="form-control-label">Do you own land</label>
                                        <div class="row">
                                        <div class="col-6">
                                        <div class="form-check">
                                        <!--<input type="radio" class="form-check-input" name="disabled_handicap" value="1" id="disabledYes">-->
                                          <input type="radio" class="form-check-input" name="answer" value="yes" onclick="showInput();" /> 
                                          
                                          <label class="form-control-label">Yes</label><br>
                                        
                                        
                                        <!--   <div id="inputFile" style="display:none;" >-->
                                        <!--         <label class="form-control-label">7/12</label><br>-->
...
<div class="col-6">
<div class="form-check">
<!--<input type="radio" class="form-check-input" name="disabled_handicap" value="0" id="disabledNo">-->
<!--<label class="form-control-label" for="disabledNo">No</label>-->
  <input type="radio" class="form-check-input" name="answer" value="no" onclick="showDropdown();" /> 
  <label class="form-control-label">NO</label><br>
 ...
 <!--     <option value="3">Atikramn</option>-->
 <!--   </select>-->
 <!-- </div>-->
</div>
</div>
            ...
            <!--start-->                    <div class="col-md-6">    
                                        ...
                                        <!--<div class="col-md-6">-->
                                        <div id="dropdownList" style="display:none;">                                                                                             <label class="form-control-label">Type</label><br>
...
<div class="col-6">
<div class="form-group">
<label class="form-control-label">Area</label><br>
<div class="col-6">
<div class="form-check">
<label class="form-control-label" for="name" style="font-size:15px">No.of rooms</label>
...
<!--<input type="radio" class="form-check-input" name="janAarogya" value="0" id="janAarogyaNo">-->
<!--<label class="form-control-label" for="janAarogyaNo">No</label>-->
                                ...
                                <div class="col-md-6">
                                <h5 class="card-title">Pakka ghar ?</h5>
                                  <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input type="radio"  class="form-check-input"  onclick="showData()" name="tenPass" value="1" id="Yes">
                                                            <label
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input type="radio" class="form-check-input" onclick="hideData()" name="tenPass" value="0" id="No">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label
                                                    class="form-control-label"
                                                    for="caste">Is there tap connection</label><br>
                                                    
                                                  <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input type="radio" class="form-check-input" name="niradhar0" value="1" id="Yes">
                                                            <label class="form-control-label" for="Yes">Yes</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input type="radio" class="form-check-input" name="niradhar0"  value="0" id="No">
                                                            <label class="form-control-label" for="No">No</label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label
                                                    class="form-control-label"
                                                    for="caste">Is there electricity</label><br>
                                                    
                                                  <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input type="radio" class="form-check-input" name="niradhar1" value="1" id="Yes">
                                                            <label class="form-control-label" for="Yes">Yes</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input type="radio" class="form-check-input" name="niradhar1"  value="0" id="No">
                                                            <label class="form-control-label" for="No">No</label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label class="form-control-label" for="aadharNo">Is there toilet facility</label><br>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-check">  
                                                            <input type="radio" name="type" class="form-check-input" value="yes" onclick="document.querySelector('.field').style.display = 'block';" />
                                                            <label class="form-control-label"for="Yes">Yes</label>
                                                        </div>    
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-check"> 
                                                            <input type="radio" name="type" class="form-check-input" value="no" onclick="document.querySelector('.field').style.display = 'none';" /> 
                                                            <label class="form-control-label"for="No">No</label> 
                                                        </div>
                                                    </div>                     
                                                </div>
                                        ...
                                        <div class="col-md-6 filed" style="display:none;">
                                            <div class="form-group">
                                                <label class="form-control-label" for="aadharNo">Is there gas connection</label>
                                                <input type="text" class="form-control"id="incomeNo"name="incomeNo"placeholder="degress name">
                                            </div>  
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="incomeNo">Is there gas connection</label>
                                                    
                                                     <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input type="radio" class="form-check-input" name="niradhar3" value="1"     id="Yes">
                                                            <label class="form-control-label" for="Yes">Yes</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input type="radio" class="form-check-input" name="niradhar3" value="0" id="No">
                                                            <label class="form-control-label" for="No">No</label>
                                                        </div>
                                                    </div>
                                                </div>
                                           ...
                                           <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="education">IFR/CFR granted?</label>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-check">  
                                                            <input type="radio" name="ok" class="form-check-input" value="yes" onclick="document.querySelector('.fiel').style.display = 'block';document.querySelector('#reg').style.display = 'none';" />
                                                            <label class="form-control-label"for="Yes">Yes</label>
                                                        </div>    
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-check"> 
                                                            <input type="radio" name="ok" value="no" class="form-check-input" onclick="document.querySelector('.fiel').style.display = 'none';document.querySelector('#reg').style.display = 'block';" />
                                                            <label class="form-control-label"for="No">No</label> 
                                                        </div>
                                                    </div>                     
                                                </div>
                                        ...
                                        <div class=" form-group">
                                                <label class="form-control-label" for="name">Proposal submitted</label><br>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                        <input type="radio"  class="form-check-input"  name="niradhar6" value="1" id="Yes" onclick="document.querySelector('.fieldes').style.display = 'none';document.querySelector('.fiel').style.display = 'block';">
                                                            <label class="form-control-label" for="Yes">Yes</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input type="radio" class="form-check-input" name="niradhar6" value="0" id="No"onclick="document.querySelector('.fieldes').style.display = 'block';document.querySelector('.fiel').style.display = 'none';">
                                                            <label  class="form-control-label"  for="No">No</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label class="form-control-label" for="name">Do you want to submit</label><br>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                        <input type="radio"  class="form-check-input"  name="niradhar6" value="1" id="Yes" onclick="document.querySelector('.fieldes').style.display = 'none';document.querySelector('.fiel').style.display = 'block';">
...
<script>
    ...
    function addMember(familyId){
        var status;
        Swal.fire({
            title: 'You want to enter member?',
            icon: 'question',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            if (result.isConfirmed) {
                window.location='family-details?familyId='+familyId;
                // status = true;
            } else {
                window.location='family-details';
                // status = false;
            }
        });
